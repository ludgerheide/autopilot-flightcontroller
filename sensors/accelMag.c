...
void magCompensate(magEvent *input, magEvent *output) {
    ...
    output->x = output->x * magn_ellipsoid_transform[0][0] + output->y * magn_ellipsoid_transform[0][1] +
                output->z * magn_ellipsoid_transform[0][2];
    output->y = output->x * magn_ellipsoid_transform[1][0] + output->y * magn_ellipsoid_transform[1][1] +
                output->z * magn_ellipsoid_transform[1][2];
    output->z = output->x * magn_ellipsoid_transform[2][0] + output->y * magn_ellipsoid_transform[2][1] +
                output->z * magn_ellipsoid_transform[2][2];
