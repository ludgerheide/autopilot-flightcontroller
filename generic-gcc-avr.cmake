...
function(add_avr_executable EXECUTABLE_NAME)
    ...
    add_custom_target(
            ...
            COMMAND scp ${hex_file} ${SSH_HOST}:/tmp/ && echo "Hex File copied to remote host"
            COMMAND ${SSH_COMMAND} ${SSH_HOST} -t sudo ${AVR_UPLOADTOOL} -p ${AVR_MCU} -c ${AVR_PROGRAMMER} -P ${AVR_UPLOADTOOL_PORT} ${AVR_UPLOADTOOL_OPTIONS}
            -U flash:w:/tmp/${hex_file} && echo "Upload successful!"
            COMMAND ${SSH_COMMAND} ${SSH_HOST} -t rm /tmp/${hex_file} && echo "Hex File deleted"
            DEPENDS ${hex_file}
